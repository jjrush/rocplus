...
# @TEST-EXEC: zeek Spicy::enable_print=T -B -C -r ${TRACES}/rocplus_opcode_10.pcap ${PACKAGE} %INPUT > debug.log 2>&1
...
# @TEST-DOC: Test rocplus analyzer with rocplus_opcode_10.pcap