...
# @TEST-EXEC: touch debug.log
# @TEST-EXEC: zeek Spicy::enable_print=T -C -r ${TRACES}/realistic_tcp_traffic.pcap ${PACKAGE} %INPUT > debug.log
...
# @TEST-DOC: Test rocplus analyzer with realistic_tcp_traffic.pcap